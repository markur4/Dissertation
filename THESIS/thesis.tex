...
\includeonly{PARTS/5_SUMMARISING_DISCUSSION_cancer}
% \includeonly{PARTS/5_SUMMARISING_DISCUSSION_coding}
...
\include{PARTS/5_SUMMARISING_DISCUSSION_cancer}

\include{PARTS/5_SUMMARISING_DISCUSSION_coding}
...
\begin{appendices}
    ...
    \newpage
    \include{PARTS/6_APPENDIX_CHAPTER1_FIGURES}̉
    \newpage
