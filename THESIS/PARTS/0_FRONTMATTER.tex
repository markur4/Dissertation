...
\section*{Acknowledgements} % > The * means it's not listed in TOC
 ...
 % \begin{center}%
 {
  ...
  \acknowledge{Doris Schneider}{%
      for her exceptional assistance in laboratory work. Her patience, focus,
      and dedication were invaluable to the experimental success of this
      research.%
  }
  ...
  \acknowledge{My Family}{%
      for their unconditional support throughout my academic journey. %
  }
