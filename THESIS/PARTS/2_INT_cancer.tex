...
antibody-producing cells of the immune system \dashed{plasma cells} which
...
\dashleft{both of which will be covered across this thesis}. The prevalence of
...
smaller\footquote{Solitary plasmacytoma with \SI{10}{\percent} or more clonal
    plasma cells is regarded as multiple myeloma. [...] If bone marrow has less than
    \SI{10}{\percent} clonal plasma cells, more than one bone lesion is required to
    distinguish [\ac{MM}] from solitary plasmacytoma with minimal marrow
...
follow-up\footdagger{From \citet{abdallahModeProgressionSmoldering2024}: For
    non-high risk \ac{aMM} patients, treatment lowered \ac{MM} progression rate to
    \SI{9}{\percent}, compared to \SI{31}{\percent} for untreated patients (within
    up to 6.7 and 7.6 years of follow-up, respectively). For high-risk \ac{aMM}
    patiens, treatment lowered \ac{aMM} progression rate to \SI{11}{\percent},
    compared to \SI{72}{\percent} for untreated patients (within up to 5.2 years of
    follow-up and median time to progression of 2.2 years, respectively).}
...
\ac{IGF-1}, \ac{IL-6}, \ac{BAFF}, \ac{VEGF}, and \ac{APRIL} \dashleft{also known
    as \ac{TNFSF13}}. Among these factors, IGF-1 has proven to be the primary
...
\cite{ullahRoleCXCR4Multiple2019}. \ac{CXCL12} \dashed{also known as \ac{SDF-1}}
...
notably, their initial name \dashed{Mesenchymal \textit{Stem} Cell} was renamed
...
\acp{MSC} are sometimes wrongfully described as \emph{pluripotent}, a term
...
\dashed{also known as \emph{somatic stem cells}} maintain tissue homeostasis and
repair during adulthood. They are multipotent, meaning they can differentiate
into a limited number of cell types \dashleft{a term fitting for \acp{MSC}}. The
...
% despite thousands of clinical trials covering most of the human
...
\emph{further studies are needed}\footquote{Altogether, the articles published
    in this Special Issue raise more questions than they answer, given that most of
    the conclusions carry the statement \textbf{‘further studies are
        needed'}.}{abdelrazikMesenchymalStemCells2023}
...
Another fundamental factor contributing to bone destruction is the suppression of
...
For example, bisphosphonates \dashed{such as zoledronic acid} reduces osteoclast
...
\ac{MM} cells not only suppress osteogenic differentiation, but also drive
...
% signaling offers therapeutic potential,
% aiming to disrupt key interactions and inhibit myeloma progression. 
