...
Chapter\,1, since \autoref{tab:S2} (\mypageref{tab:S2}) provides a list of
retention targets\footref{foot:retentiveadhesionfactors} that were associated
...
these factors allows for rapid reattachment \dashleft{if required}. Quir
