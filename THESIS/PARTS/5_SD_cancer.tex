...
\newcommand{\footinteractionscenario}{%
      ...
      \dashed{homotypic}, different types \dashed{heterotypic}, or between cells
...
Where a phenotype summarizes both the genetic and environmental influences on
...
%TODO: 
% - rename CADD to CAD (Cell Adhesion Dynamics) for simplification. Include 
% that chapter 1 uset attachment/detachment dynamics
% - Define what a CAD dramatype is.
...
\emph{dramatype}\footnotequote{\footdramatype}{zutphenPrinciplesLaboratoryAnimal2001}
...
To distinguish between proximate environmental factors
...
% This is a similar problem faced in animal models,
% where the term \emph{dramatype} was introduced
% \cite{zutphenPrinciplesLaboratoryAnimal2001}

to distinguish between
given the focus on proximate environmental factors
\dashed{\ac{MSC} interaction},
...
from an extramedullary site \dashed{the pleura}
...
% for survival and treatment escape. They report
%  widespread changes across such transcriptioal states,  of surface
% markers, and identify signatures of endothelial progenitors and enhancers linked to
% CXCR4 .

This is indicative of myeloma cells
...
% there are distinct alternate transcriptional states that myeloma cells  

% regulon usage and enhancer rewiring
% can switch between
% distinct transcriptomic states 
%   transcriptional plasticity and to for survival and
%  treatment escape \cite{fredeDynamicTranscriptionalReprogramming2021}
...
\apdxref{subapdx:tabs}{tab:S1} presents a robust starting point, as this work
...
% This
% section explores the hypothesis that such rapid adaptability of \ac{CADD} is a
% hallmark of aggressive myeloma.

% Not only did \MAina upregulate adhesion
% factors fast, but also generated daughter cells that lost \ac{MSC} attachment
% and adhesion factor expression.
% At the same time, \INA cells

% This sugests that \ac{CADD} adaptations can occur extremely fast.
...
% dynamically express adhesion factors particularly fast. 
