...
\newcommand{\footcadd}{%
      ...
      detached and associates molecular signatures with these phases, such as
...
\dashed{each step being very complex itself}, the connection of these steps
...
\newcommand{\caddadaptationtitle}{ %
      ...
      % Myeloma Cells Adapt \ac{CADD} during
      % Dissemination
}%
...
This assumes that there are other mechanisms involved in dissemination
