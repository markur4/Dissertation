...
However, since evidence is collected mostly for individual steps \dashed{each
      step being very complex itself}, the connection of these steps remains unproven
...
Observation: \INA  cells detach from \acp{hMSC} through cell division, and external forces can detach
...
%       \acf{CADD} can predict steps within dissemination. %
% }%
% \newcommand{\caddpredictionstitle}{ %
%       \textit{Hypothesis 1}: \acf{CADD} Can Predict Dissemination %
% }%
