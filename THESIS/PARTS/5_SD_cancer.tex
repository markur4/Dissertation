...
\newcommand{\footattachdetachdynamics}{%
      \emph{\ac{CAD} Dynamics}: The observation and measurement of
      time-dependent changes in cell adhesion. This includes the time required
      for attachment, detachment, and migration of cells. This
      term\dashed{defined in this work}expands traditional \emph{cell adhesion}
      by an emphasis on the time component and further characterization of
      detachment events.} \newcommand{\footattachdetachbehaviour}{%
      \emph{\ac{CAD} Behaviour}: The summary of all
      \emph{\ac{CAD} dynamics} observable in a cell.}
...
\textbf{\acf{CAD} Behavior and Predicting Dissemination}
