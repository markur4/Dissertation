...
extramedullary site \dashed{the pleura} \cite{burgerGp130RasMediated2001}, such
...
% \textbf{\textit{Concluding Remarks:}} The exploration of changing \ac{CAD} dramatypes
...
% Such studies will be crucial for validating the changing \ac{CAD} dramatype
% hypothesis and for identifying potential therapeutic targets that could disrupt
% the dissemination process at various stages.
...
\apdxref{subapdx:tabs}{tab:S1} providing a strong starting point.
...
% This
% section explores the hypothesis that such rapid adaptability of \ac{CAD} is a
% hallmark of aggressive myeloma.
...
% This sugests that \ac{CAD} adaptations can occur extremely fast.
