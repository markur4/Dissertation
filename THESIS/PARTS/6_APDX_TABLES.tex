...
\def\myheader{
    \hline
    \textbf{Cell Type} & \textbf{Donor / Line} & \textbf{Donor Ages} &
    \textbf{Donor Sex} & \textbf{Date of negative Mycoplasma test} &
    \textbf{\footnotesize Experiment(s)}
    & \textbf{Figures}                        \\
    \hline
}
...
\begin{longtable}{%
    ...
    \caption{%
        List of hMSC donors, myeloma cell lines, and their mycoplasma test
        status. If no unique donors were available, hMSC donors were used twice
        for the same experiment at different passages. WPSC: Well plate sandwich
        centrifugation. \selfplagiarismone }%
    \label{tab:S1}
    \\
    \myheader
    \endfirsthead

    \longtablecaptions{6}{Appendix~\thesection} % > Include captions around pagebreaks
...
\begin{spacing}{1}
    {
        ...
        \def\myheader{
            ...
            \textbf{\scriptsize Ensemble ID} & \textbf{Progression Free /
                Overall Survival} & \textbf{Better Prognosis with high/low
                expression} & \multicolumn{2}{p{3cm}|}{\textbf{Association of
        ...
        \begin{longtable}{%
            ...
            \caption{ %
                Adhesion genes (from \autoref{fig:6}A) categorized by a
                continuous downregulation across disease progression. Bone
                Marrow Plasma Cell (BMPC), Monoclonal Gammopathy of Undetermined
                Significance (MGUS), Smoldering Multiple Myeloma (sMM), Multiple
                Myeloma (MM), Multiple Myeloma Relapse (MMR). p-adj. = adjusted
                p-values (Benj.-Hoch.). \selfplagiarismone }%
            \label{tab:S2}                                                          \\
            \myheader
            \endfirsthead

            \longtablecaptions{3}{Appendix~\thesection} % > Include captions around pagebreaks
