...
\begin{longtable}{|>{\bfseries}p{1.5cm}|>{\bfseries}p{1.2cm}|p{1.2cm}|p{1cm}|p{2.3cm}|p{6cm}|p{1.7cm}|}
    \caption{%
        List of hMSC donors, myeloma cell lines, and their mycoplasma test status.
        If no unique donors were available, hMSC donors were used twice for the same
        experiment at different passages. WPSC: Well plate sandwich centrifugation.
    }\label{tab:S1}                                                                                                                                                                     \\
    \myheader
    \endfirsthead
