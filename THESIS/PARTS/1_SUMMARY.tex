...
\begin{abstract}
    ...
    they offer an approach to handling complex experiments,
...
\begin{abstract}
    ...
    zur Untersuchung der Dissemination von Myelomzellen sowie ein
    ...
    Im experimentellen Teil werden primäre menschliche mesenchymale Stromazellen
     (hMSCs) mit INA-6-Myelomzellen kokultiviert, um Zellproliferation,
    ...
    Zur Verwaltung komplexer Daten wurde eine Python-basierte Software namens
     \texttt{plotastic} entwickelt, welche die Analyse und Visualisierung
    ...
    Ansatz für die Bearbeitung komplexer Experimente, fördern sowohl
