...
V-Well is described in \refapdx{sec:sup_figtabs}{fig:S1}

V-Well is described in \refapdx{sec:sup_figtabs}{fig:S1}, \ref{fig:S2}

Image cytometry is described in \autoref{sec:sup_figtabs} \autoref{fig:S2}
