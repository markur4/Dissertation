...
\includeimage[1][{\fmleft} 5.4in {\fmright} {\fmtop}]{
    ...
    cultures with hMSCs from three unique donors. }\label{fig:3}
...
% revealing \SI{1291}{} differentially expressed genes between
% \versus{\nMAina}{\CMina}, \SI{484}{} between \MAina\,vs.\,\CMina, and \SI{195}{}
% between \MAina\,vs.\,\nMAina. We validated RNAseq and found that the
% differential expression of \SI{18}{} genes correlated with those measured with
% qPCR for each pairwise comparison (\autoref{fig:4}C--E,
% \apdxref{apdx:supplemental}{fig:S5}): \nMAina\,vs.\,\CMina [\(\rho(16) = .803\),
% \(p = 6.09 \times 10^{-5}\)], \MAina\,vs.\,\CMina [\(\rho(16) = .827\), \(p =
% 2.30 \times 10^{-5}\)], and \MAina\,\textit{vs.}\,\nMAina [\(\rho(16) = .746\), \(p =
% 3.74 \times 10^{-4}\)] (Spearman’s rank correlation). One of the \SI{18}{} genes
% (\textit{MUC1}) measured by qPCR showed a mean expression opposite to that
% obtained by RNAseq (\nMAina\,vs.\,\CMina), although the difference was
% insignificant (\autoref{fig:4}C). For \nMAina\,vs.\,\CMina, the difference in
% expression measured by qPCR was significant for only two of the \SI{11}{} genes
...
% (\autoref{fig:4}C--E). For \MAina\,vs.\,\CMina, qPCR validated the significant
% upregulation of seven genes (\listit{TGM2, DCN, LOX, MMP14, MMP2, CXCL12,
% CXCL8}), whereas the downregulation of \textit{BMP4} was insignificant.

\subsubsection*{RNAseq of Non-MSC-Adhering and MSC-Adhering Subpopulations}
To characterize the subpopulations separated by WPSC, we conducted RNAseq,
revealing \SI{1291}{} differentially expressed genes \versus{\nMAina}{\CMina},
\SI{484}{} \versus{\MAina}{\CMina}, and \SI{195}{} \versus{\MAina}{\nMAina}. We
validated RNAseq and found that the differential expression of \SI{18}{} genes
...
measured by qPCR was significant for only two of the \SI{11}{genes} 
(\listit{DKK1, OPG}), whereas the other genes (\listit{BCL6, BMP4, BTG2, IL10RB,
IL24, NOTCH2, TNFRSF1A, TRAF5}) only confirmed the tendency measured by RNAseq
...
% [𝜌(16) = .803, p = 6.09e-5] turns into \omnibus{\rho}{16}{.803}{}{\scinot{6.09}{-5}}

% [F(2,3) = .888, p-unc = 9.13e-6] turns into \omnibus{\rho}{2,3}{.888}{-unc}{\scinot{9.13}{-6}}
% \omnibus{\rho}{16}{.803}{-unc}{\num{123e23}}

% \omnibus{\rho}{16}{.803}{$p$-unc}{$6.09 \times 10^{-5}$}
