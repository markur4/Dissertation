...
V-Well is described in \refapdx{apdx:sup_figtabs}{fig:S1}

V-Well is described in \refapdx{apdx:sup_figtabs}{fig:S1}, \ref{fig:S2}

Image cytometry is described in \autoref{apdx:sup_figtabs} \autoref{fig:S2}
