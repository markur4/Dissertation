...
formation restricted to MM containing bones.
...
pathways, exacerbating \ac{MM} pathology. Targeting NF-$\kappa$B offers
therapeutic potential, aiming to disrupt key interactions and inhibit myeloma
progression. Deeper molecular understanding could lead to therapies that
effectively target the cancer microenvironment driving \ac{MM} progression.

% Overall, the \ac{BMME} and \acp{MSC} play a pivotal role, not only as structural
% and functional scaffolds but also as dynamic responders to pathological cues in
% \ac{MM}. The central role of NF-$\kappa$B signaling in the interactions between
% myeloma cells and \acp{MSC} underscores its importance in both sustaining
% myeloma cell survival and altering \ac{MSC} functions
% \cite{cippitelliRoleNFkBSignaling2023, royNFkBActivatingPathways2018}. Direct
% cell-cell contact could be essential for activating these signaling pathways,
% leading to a cascade of cellular responses that significantly exacerbate \ac{MM}
% pathology. This intimate interplay highlights the potential of targeting
% NF-$\kappa$B and related pathways as a strategy for \ac{MM} therapy.
% Understanding these interactions at a molecular level offers promising avenues
% for identifying new therapeutic targets that could disrupt the critical
% communication between myeloma cells and \acp{MSC}, aiming to restore normal bone
% marrow function and inhibit myeloma progression. By delving deeper into these
% molecular mechanisms, future research could pave the way for innovative
% treatments that more effectively target the microenvironmental support
% structures essential for myeloma survival and proliferation.
