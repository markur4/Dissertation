...
As the name suggests, \emph{multiple} myeloma  involves spreading of clonal plasma
...
multiple tumor lesions within the \ac{BM} is very common. More than one
...
five steps: \emph{Retention in the \ac{BM}}, \emph{release from the \ac{BM}},
...
\ac{MM} cells overcoming retention and adhesion within the \acl{BM} environment (BME).
Following release, \ac{MM} cells undergo \emph{intravasation} into the bloodstream,
where they can circulate before extravasating into new \ac{BM} sites. This migration
is directed by chemokines and growth factors produced by \ac{BM} cells. For instance,
CXCL12 and IGF-1 are critical in guiding \ac{MM} cells back to the \ac{BM}, a process
...
\emph{Direct adhesion} of \ac{MM} cells to the \ac{BM} is mediated through ECM components
and cell adhesion to other \ac{BM} resident cells like osteoblasts, osteoclasts and
...
\cite{huDecorinmediatedSuppressionTumorigenesis2021,
    ...
    kiblerAdhesiveInteractionsHuman1998}. \acl{BM} mesenchymal stromal cells (BMSCs) are
...
\emph{Soluble survival factors} contribute to \ac{BM} retention, since plasma cells
can not survive outside the bone marrow without them. For example, deleting BCMA
\dashedsentence{a receptor for survival factors} leads to loss of \acp{BMPC}  due to unsustained maintenance of cell survival
...
for \ac{BM} retention. CXCL12 and CXCL8 are soluble chemotactic signals produced by
...
Together, BMSCs play a critical role in \ac{MM} retention, providing direct
...
with \ac{MGUS} and \ac{aMM}. This further shows that regulation of CAMs
