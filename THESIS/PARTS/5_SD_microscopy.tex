...
from movement \dashed{or rather lack thereof} which was interpreted as
...
\textbf{Difficulties Connecting Observation with Acedemic Terminology:}
...
video data%
\footdagger{The total number of \textit{PubMed} articles with \emph{``live cell
        imaging''} has doubled from 1012 articles in the year 2011 to 1967
        articles in 2023}, %
...
analyses often miss \dashleft{probably}. This is exemplified in this work, where
...
convolution layers of VGG19 \dashleft{a convolutional neural
...
\dashleft{involving up to 24 samples per trial
(\apdxref{subapdx:figs}{fig:S3})}. Despite having access to automated \ac{FACS}
...
fluorescent images. However, training with non-fluorescent images \dashed{e.g.
phase contrast} required a far greater number of annotated training images to
