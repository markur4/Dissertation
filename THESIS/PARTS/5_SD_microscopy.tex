...
% transcription factors: E2F1 for nMA-INA6; and NF-$\kappa$B, SRF, and JUN for
% MA-INA6. This distinction may have been established through antagonism
% between p53 and the NF-$\kappa$B subunit RELA/p65 (38,39). Similar regulatory
...
% marrow; MA-INA6 strongly adhered to MSCs, showed NF-$\kappa$B signaling, and
...
video data%
\footdagger{The number of \texttt{PubMed} articles with \emph{``live cell
        imaging''} has doubled from 2011 to 2023.}, %
...
no reason to not present videos alongsife figures and tables, as they can be as
