...
The following paragraphs will discuss the previously presented chapters both in
terms of how they integrate within current scientific fields, but also outlay
technical and academic challenges that were faced during the course of this
project. Given the broad scope of the shown topics, this discussion is
structured into three main sections: Microscopy, Molecular Biology, and Data
Analysis. Each section will explain key experiments that
% ======================================================================
% ======================================================================
...
into myeloma cell behavior. The findings underscored the critical role of
MSC-interactions in shaping cell behavior, e.g. \INA cells showed a preference
for heterotypic interactions with hMSCs. These techniques revealed dynamic
processes, such as cell detachment and migration, which are pivotal for
