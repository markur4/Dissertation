...
\cite{qureshiAreChatGPTLarge2023}\footquote{You can now recognize and learn
...
should also be noted that \texttt{plotastic} is not yet known to \textit{ChatGPT}, but
