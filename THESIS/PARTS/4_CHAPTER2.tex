...
\cite{krzywinskiMultidimensionalData2013}. Modern biosciences rely on complex
experiments, for example for processes that are highly time-dependent, like
cell-adhesion \cite{reblTimedependentMetabolicActivity2010,
