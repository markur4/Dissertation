...
\newcommand{\footcaddt}{%
    ...
    proximate environmental factors. Since the term dramatype implies dynamic
    changes, CAD dramatypes can be shortened to adhesion dramatypes. %
}

\newcommand{\footadhesiondt}{%
    \emph{Adhesion dramatype} (specified in this work): Short version for
    \ac{CAD} dramatype. Since the term dramatype implies dynamic changes, CAD
    dramatypes and adhesion dramatypes are interchangable.%
}
