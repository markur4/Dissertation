...
\def\footadhesionfactor{%
    ...
    \acl{CAM} (\acs{CAM}), \acl{ECM} (\acs{ECM}) proteins, chemotactic factors
    associated with inducing adhesion factor expression \dashed{such as CXCR4 or
    CXCL12}, and factors listed in Gene ontology terms \textit{“extracellular
    matrix organization”}, \textit{“ECM proteoglycans”}, \textit{“cell-substrate
    adhesion”}, and \textit{“negative regulation of cell-substrate adhesion”}.
    }%
