...
% This led to many advances
% spanning multiple fields of biology, image processing and machine learning,
% potentially ushering a new era of \emph{image cytometry}
% \cite{guptaDeepLearningImage2019}. The definition of image cytometry is
% broadly defined as extracting measurements from microscopy images of cells or
% subcellular structures and has great potential for automated approaches to
% quantitative microscopy \cite{guptaDeepLearningImage2019}.
...
% \textbf{Live-Cell Image Analysis Computational Tools for Future Live-Cell Image Analysis:}
...
learning algorithm that \dashedsentence{for small sets of training images}
...
% ========
\textbf{Image Cytometry Achieved Competitive Precision and Throughput:}
...
(\apdxref{subapdx:figs}{fig:S3}). Although automated \ac{FACS} allow for high
...
to flow cytometry (\apdxref{subapdx:figs}{fig:S2}). Although this work has not
...
Together, this work exemplifies the quantitative potential of image cytometry
